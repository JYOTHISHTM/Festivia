...
const SidebarNavigation = () => {
  ...
  const handleLogout = async () => {
    try {
      ...
      window.location.replace("/creator/login"); // <--- Forces full refresh
  ...
  const menuItems = [
    ...
    { id: 'SUBSCRIPTION_DETAILS', icon: FileText, label: 'SUBSCRIPTION DETAILS', path: '#' },
    ...
    { id: 'TICKET_SALES', icon: Ticket, label: 'TICKET SALES & EARNINGS', path: '#' },
    { id: 'WALLET', icon: Wallet, label: 'WALLET', path: '#' },
