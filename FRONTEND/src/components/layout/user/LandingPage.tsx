// import image from '../../../assets/images/pexels-pixabay-264787.jpg';
...
//   const events = [
//     { id: 1, title: 'International Jazz Festival', image: image },
//     { id: 2, title: 'International Jazz Festival', image: image },
//     { id: 3, title: 'International Jazz Festival', image: image },
//     { id: 4, title: 'International Jazz Festival', image: image },
//     { id: 5, title: 'International Jazz Festival', image: image },
//     { id: 6, title: 'International Jazz Festival', image: image }
//   ];
...
//   const images = ['/pexels-pixabay-264787.jpg', '/pexels-pixabay-264787.jpg', '/pexels-pixabay-264787.jpg', '/pexels-pixabay-264787.jpg'];
...
//                   <img src={src} alt={`Gallery image ${index + 1}`} className="object-cover w-full h-full rounded-lg shadow-xl" />
//                 </div>
//               </div>
//             ))}
//           </div>
...
//         <div className="mb-12">
//           <h1 className="text-2xl font-normal tracking-wider mb-8">PUBLIC EVENTS</h1>
//           <div className="flex gap-3 mb-8">
//             <input type="text" placeholder="Search Location" className="w-full px-3 py-2 rounded bg-gray-100 pr-8 text-sm" />
//             <input type="text" placeholder="Search Date" className="w-full px-3 py-2 rounded bg-gray-100 pr-8 text-sm" />
//             <input type="text" placeholder="Search Date" className="w-full px-3 py-2 rounded bg-gray-100 pr-8 text-sm" />
//             <button className="px-6 py-2 bg-gray-200 rounded text-sm">GO</button>
//           </div>
//           <div className="mb-8">
...
//             {events.map((event) => (
//               <div key={event.id} className="relative group cursor-pointer overflow-hidden rounded-2xl shadow-lg hover:scale-105 transition-transform duration-300">
//                 <img src={event.image} alt={event.title} className="w-full h-60 object-cover rounded-2xl" />
//                 <div className="absolute bottom-3 left-3 right-3">
//                   <div className="bg-white bg-opacity-95 px-4 py-1.5 rounded-full">
//                     <p className="text-center text-xs font-medium">{event.title}</p>
//                   </div>
//                 </div>
