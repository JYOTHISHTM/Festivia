        ...
        <div className="w-1/2 p-8 bg-white">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button
              ...
              className="w-2/7 flex ml-20 items-center justify-center gap-3 mt-4 bg-white border-2 border-gray-300 py-3 rounded-lg text-lg font-semibold cursor-pointer transition-all shadow-md hover:bg-gray-200"
            >
              <FcGoogle size={24} />
            </button>
